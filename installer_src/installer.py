...
def _setup_logging() -> str:
    ...
    from installer_src import cache, config
...
def main() -> int:
    ...
    from installer_src.ui.theme import apply_theme
    from installer_src.ui.wizard import InstallerWizard

    app = QApplication(sys.argv)
    app.setApplicationName("GTA SAS 1987 Installer")
    from installer_src import config
